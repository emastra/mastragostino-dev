...
const BookConsultationPage: React.FC = () => {
  return (
    <div className="dark:from-neutral-950 dark:to-neutral-950 min-h-screen bg-gradient-to-br from-neutral-50 via-white to-neutral-50 dark:via-neutral-900">
      {/* Hero Section */}
      {/* <HeroSection /> */}
...
function HeroSection() {
  return (
    <section className="relative overflow-hidden px-4 py-20 md:py-28">
      ...
      <div className="absolute top-20 right-1/4 h-96 w-96 rounded-full bg-primary-500/10 blur-3xl" />
      <div className="absolute bottom-20 left-1/4 h-96 w-96 rounded-full bg-accent-500/10 blur-3xl" />

      <div className="container relative z-10 mx-auto max-w-4xl text-center">
        {/* Badge */}
        <div className="dark:bg-accent-950/30 mb-6 inline-flex items-center gap-2 rounded-full border border-accent-200 bg-accent-50 px-4 py-2 text-sm font-semibold text-accent-700 dark:border-accent-900/50 dark:text-accent-300">
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {includes.map((item, index) => (
            ...
            >
              {/* Number badge */}
              <div className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 text-sm font-bold text-neutral-400 dark:bg-neutral-800 dark:text-neutral-600">
                {index + 1}
              </div>
...
function Testimonial() {
  return (
    <div className="dark:to-accent-950/20 relative overflow-hidden rounded-2xl border border-accent-200 bg-gradient-to-br from-accent-50 to-amber-50 p-8 dark:border-accent-900/50 dark:from-neutral-900">
      {/* Quote icon */}
      <div className="absolute top-6 right-6 text-6xl text-accent-200 dark:text-accent-900/50">
        "
      </div>
...
function Badge({ children }: { children: React.ReactNode }) {
  return (
    <span className="dark:bg-primary-950/30 inline-flex items-center rounded-full border border-primary-200 bg-primary-50 px-3 py-1 text-xs font-medium text-primary-700 dark:border-primary-900/50 dark:text-primary-300">
      {children}
    </span>
  );
}
  ...
  return (
    <section className="px-4 py-20">
      <div className="container mx-auto max-w-4xl">
        {/* Section Header */}
        <div className="mb-12 text-center">
          <div className="dark:bg-primary-950/30 mb-4 inline-flex items-center gap-2 rounded-full border border-primary-200 bg-primary-50 px-4 py-2 text-sm font-semibold text-primary-700 dark:border-primary-900/50 dark:text-primary-300">
        ...
        <div className="overflow-hidden rounded-3xl border-2 border-primary-200 bg-white shadow-xl dark:border-primary-800 dark:bg-neutral-900">
          {/* Calendar Header */}
          <div className="dark:from-primary-950/20 dark:to-accent-950/20 border-b border-neutral-200 bg-gradient-to-r from-primary-50 to-accent-50 px-6 py-4 dark:border-neutral-800">
    ...
    <div className="flex min-h-[500px] items-center justify-center bg-gradient-to-br from-neutral-50 to-neutral-100 p-12 dark:from-neutral-900 dark:to-neutral-800">
      <div className="text-center">
        <div className="mb-6 flex justify-center">
          <div className="dark:bg-primary-950/30 flex h-24 w-24 items-center justify-center rounded-full bg-primary-100">
