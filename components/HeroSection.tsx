...
export default function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden px-6 py-12 md:py-24">
      ...
      {/* Glow Effect */}
      <div className="absolute left-1/2 top-2  h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full bg-primary-500/20 blur-[90px] md:h-[500px] md:w-[500px] md:blur-[120px]"></div>
